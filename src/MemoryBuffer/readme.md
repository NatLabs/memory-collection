...
- ~~**sortUnstable() - #GenCmp**~~ (**Deprecated — removed**) - quicksort - sorted by deserializing elements to their original type before comparing. Removed because it required the stored type to be deserializable from a (potentially truncated) blob.
...
| ~~sortUnstable() #GenCmp~~ *(deprecated)* |   101_270_997 |               2_404_559_478 |                   2_151_767_821 |
...
| ~~sortUnstable() #GenCmp~~ *(deprecated)* | 2_520_996 |                   3_402_300 |                     -24_828_540 |
